...
module lab7_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> Execute_s1_agent:cp_valid
	wire  [107:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> Execute_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // Execute_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [16:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> Execute_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> Execute_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> Execute_s1_agent:cp_endofpacket
	...
	wire          execute_s1_agent_rp_valid;                                                          // Execute_s1_agent:rp_valid -> router_009:sink_valid
	wire  [107:0] execute_s1_agent_rp_data;                                                           // Execute_s1_agent:rp_data -> router_009:sink_data
	wire          execute_s1_agent_rp_ready;                                                          // router_009:sink_ready -> Execute_s1_agent:rp_ready
	wire          execute_s1_agent_rp_startofpacket;                                                  // Execute_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          execute_s1_agent_rp_endofpacket;                                                    // Execute_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          execute_s1_agent_rdata_fifo_src_valid;                                              // Execute_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] execute_s1_agent_rdata_fifo_src_data;                                               // Execute_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          execute_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_007:in_0_ready -> Execute_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> Execute_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> Execute_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // Execute_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> Execute_s1_agent:rdata_fifo_sink_error
